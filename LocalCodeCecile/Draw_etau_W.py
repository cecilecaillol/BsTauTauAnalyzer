...
file=ROOT.TFile("datacard_etau_2018.root","r")
if args.year=="2017":
   file=ROOT.TFile("datacard_etau_2017.root","r")

if args.year=="2016":
   file=ROOT.TFile("datacard_etau_2016.root","r")

if args.year=="2016post":
   file=ROOT.TFile("datacard_etau_2016post.root","r")

if args.year=="2016pre":
   file=ROOT.TFile("datacard_etau_2016pre.root","r")
...
#categories=["et_0","et_1","et_2","et_3","et_4","et_5"]
...
for i in range (0,ncat):
   ...
   if args.year=="2018" or args.year=="2017": GGTT=file.Get(categories[i]).Get("GGTT")
   if args.year=="2018" or args.year=="2017": GGWW=file.Get(categories[i]).Get("GGWW")
   #VV.Add(W.Clone())
   Fake=file.Get(categories[i]).Get("W")
   ...
   if args.year=="2018" or args.year=="2017": GGWW.SetFillColor(ROOT.kGreen+1)
   ...
   Data.SetLineColor(1)
   Data.SetLineWidth(2)
   if args.year=="2018" or args.year=="2017": GGWW.SetLineColor(1)

   if args.year=="2018" or args.year=="2017": GGTT.SetLineColor(2)
   if args.year=="2018" or args.year=="2017": GGTT.SetLineWidth(3)

   if args.year=="2018" or args.year=="2017": GGTTfull=GGTT.Clone()
   if args.year=="2018" or args.year=="2017": GGTTfull.SetFillColor(2)
   if args.year=="2018" or args.year=="2017": GGTTfull.SetLineColor(1)
   if args.year=="2018" or args.year=="2017": GGTTfull.SetLineWidth(1)

   stack=ROOT.THStack("stack","stack")
   stack.Add(TT)
   stack.Add(Fake)
   stack.Add(VV)
   if args.year=="2018" or args.year=="2017": stack.Add(GGWW)
   stack.Add(ZLL)
   stack.Add(ZTT)
   if args.year=="2018" or args.year=="2017": stack.Add(GGTTfull)

   errorBand = ZLL.Clone()
   errorBand.Add(TT)
   errorBand.Add(ZTT)
   errorBand.Add(VV)
   if args.year=="2018" or args.year=="2017": errorBand.Add(GGWW)
   errorBand.Add(Fake)
   if args.year=="2018" or args.year=="2017": errorBand.Add(GGTTfull)
   ...
   if args.year=="2018" or args.year=="2017": legende.AddEntry(GGWW,"#gamma#gamma#rightarrow WW","f")
   legende.AddEntry(Fake,"Fake","f")
   if args.year=="2018" or args.year=="2017": legende.AddEntry(GGTTfull,"Signal","f")
   ...
   c.Modified()
   c.SaveAs("plots_etau_"+args.year+"/Wcontrol_"+name[i]+".pdf")
   c.SaveAs("plots_etau_"+args.year+"/Wcontrol_"+name[i]+".png")

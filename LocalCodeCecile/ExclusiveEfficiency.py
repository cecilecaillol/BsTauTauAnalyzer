...
def make_legend():
        output = ROOT.TLegend(0.45, 0.24, 0.9, 0.44, "", "brNDC")
...
file1=ROOT.TFile("GGTT_eff_etau_2018.root","r")
file2=ROOT.TFile("ZTT_eff_etau_2018.root","r")
...
for j in range(0,ncat):
  ...
  h1c.GetYaxis().SetTitle("Cumulative efficiency")
  h1c.SetLineWidth(3)
  h1c.Draw("hist")

...
def make_legend():
        output = ROOT.TLegend(0.2, 0.65, 0.92, 0.86, "", "brNDC")
...
Data.SetMaximum(max(Data.GetMaximum()*1.4,errorBand.GetMaximum()*1.4))
Data.SetMinimum(0.1)
...
#h1.Divide(hwoE)
#h3.Divide(hwoE)
#h1.GetXaxis().SetTitle("N_{#lower[-0.25]{tracks}}")
...
c.cd()
pad3 = ROOT.TPad("pad3","pad3",0,0,1,0.35);
...
subData.SetMaximum(130)
subData.GetYaxis().SetNdivisions(505)
subData.Draw("e0")
subSig=GGTT.Clone()
subSig.SetLineWidth(5)
subSig.SetLineColor(ROOT.TColor.GetColor("#ee7674"))
...
leg1 = ROOT.TLegend(0.29, 0.8, 0.8, 0.95, "", "brNDC")
leg1.SetNColumns(3)
leg1.SetLineWidth(0)
leg1.SetLineStyle(0)
leg1.SetFillStyle(0)
...
c.Modified()
c.SaveAs("courier.pdf")
c.SaveAs("courier.png")

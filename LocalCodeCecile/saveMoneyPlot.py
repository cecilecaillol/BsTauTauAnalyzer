...
t2.DrawText(0.01, 7.4, "SM");

line = ROOT.TLine(0.0011772, 0.4, 0.0011772, 7.6);
line.SetLineStyle(2);
line.SetLineColor(ROOT.kRed);
line.Draw();

line2 = ROOT.TLine(-0.1,2.5,0.07,2.5);
line2.Draw();
...
c1.SaveAs("Figure_012-a.pdf")
c1.SaveAs("Figure_012-a.png")
c1.SaveAs("Figure_012-a.root")

...
file=ROOT.TFile("datacard_tauidele_2018.root","r")
if args.year=="2017":
...
categories=["tauidele_0","tauidele_1","tauidele_2","tauidele_3"]
name=["mvis_ntrackslt10","tauid_allntracks","mt_ntrackslt10","mt_allntracks"]
title=["m_{vis} (GeV)","m_{vis} (GeV)","m_{T} (GeV)","m_{T} (GeV)"]
ncat=4

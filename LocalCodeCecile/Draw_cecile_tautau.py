...
file=ROOT.TFile("cecile_datacard_tautau_2018.root","r")
if args.year=="2017":
...
for i in range (0,ncat):
   ...
   c.Modified()
   c.SaveAs("plots_tautau_"+args.year+"/cecile_control_"+name[i]+".pdf")
   c.SaveAs("plots_tautau_"+args.year+"/cecile_control_"+name[i]+".png")

...
for i in range (0,ncat):
   ...
   if args.year=="2018": GGTTfull=GGTT.Clone()
   if args.year=="2018": GGTTfull.SetFillColor(2)
   ...
   stack.Add(ZLL)
   stack.Add(ZTT)
   if args.year=="2018": stack.Add(GGTTfull)
   ...
   errorBand.Add(Fake)
   if args.year=="2018": errorBand.Add(GGTTfull)
   ...
   if args.year=="2018": legende.AddEntry(GGTT,"Signal x 3","l")

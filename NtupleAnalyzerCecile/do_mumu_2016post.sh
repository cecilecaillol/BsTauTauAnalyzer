...
./FinalSelection_mumu.exe 2016post /eos/cms/store/group/cmst3/group/taug2/AnalysisCecile/ntuples_mumu_2016post/GGWW.root output_mumu_2016post/GGWW.root GGWW GGWW
...
cp datacard_mumu_2016post.root pdf_datacard_mumu_2016post.root

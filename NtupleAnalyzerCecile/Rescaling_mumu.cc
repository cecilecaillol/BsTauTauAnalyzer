...
int main(int argc, char** argv) {
	...
	if (acoplanarity_<0.02 and os_ and ((name!="data_obs" and sum_ntracks_==1) or (name=="data_obs" and ntracksAll_==0))) h_lownt->Fill(mvis,weight_*aweight_*npvs_weight_*ntpu_weight_);
        if (acoplanarity_<0.02 and os_ and ((name!="data_obs" and sum_ntracks_>=7) or (name=="data_obs" and ntracksAll_>=7))) h_highnt->Fill(mvis,weight_*aweight_*npvs_weight_*ntpu_weight_);

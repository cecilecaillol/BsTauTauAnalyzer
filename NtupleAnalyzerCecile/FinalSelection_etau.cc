...
cout<<xs<<" "<<ngen<<" "<<ngenu<<" "<<weight<<endl;
    ...
    //if (output.find("renano") < 140){
      ...
      //else if (sample=="GGEE") weight*=0.2064;
   ...
   TFile* f_taufr_run2 = new TFile("fakerate/FitValues_tauFR_run2.root");

   TH1F *err_nt0_ffW = (TH1F*) f_taufr_run2->Get("err_nt0_ffW");
   TH1F *err_nt0_ffQCD = (TH1F*) f_taufr_run2->Get("err_nt0_ffQCD");
   ...
   TF1 *fit_taufrnt_QCD_dm0 = (TF1*) f_taufr_run2->Get("theFit_nt_QCD_dm0");
   TF1 *fit_taufrnt_QCD_dm1 = (TF1*) f_taufr_run2->Get("theFit_nt_QCD_dm1");
   TF1 *fit_taufrnt_QCD_dm10 = (TF1*) f_taufr_run2->Get("theFit_nt_QCD_dm10");
   TF1 *fit_taufrnt_QCD_dm11 = (TF1*) f_taufr_run2->Get("theFit_nt_QCD_dm11");
   TF1 *fit_taufrnt_W_dm0 = (TF1*) f_taufr_run2->Get("theFit_nt_W_dm0");
   TF1 *fit_taufrnt_W_dm1 = (TF1*) f_taufr_run2->Get("theFit_nt_W_dm1");
   TF1 *fit_taufrnt_W_dm10 = (TF1*) f_taufr_run2->Get("theFit_nt_W_dm10");
   TF1 *fit_taufrnt_W_dm11 = (TF1*) f_taufr_run2->Get("theFit_nt_W_dm11");

   TF1 *fitlow_taufrnt_QCD_dm0 = (TF1*) f_taufr_run2->Get("theFit2_nt_QCD_dm0");
   TF1 *fitlow_taufrnt_QCD_dm1 = (TF1*) f_taufr_run2->Get("theFit2_nt_QCD_dm1");
   TF1 *fitlow_taufrnt_QCD_dm10 = (TF1*) f_taufr_run2->Get("theFit2_nt_QCD_dm10");
   TF1 *fitlow_taufrnt_QCD_dm11 = (TF1*) f_taufr_run2->Get("theFit2_nt_QCD_dm11");
   TF1 *fitlow_taufrnt_W_dm0 = (TF1*) f_taufr_run2->Get("theFit2_nt_W_dm0");
   TF1 *fitlow_taufrnt_W_dm1 = (TF1*) f_taufr_run2->Get("theFit2_nt_W_dm1");
   TF1 *fitlow_taufrnt_W_dm10 = (TF1*) f_taufr_run2->Get("theFit2_nt_W_dm10");
   TF1 *fitlow_taufrnt_W_dm11 = (TF1*) f_taufr_run2->Get("theFit2_nt_W_dm11");
...
cout<<"g2 branches"<<endl;
   ...
   for (Int_t i = 0; i < nentries_wtn; i++) {
	...
	if (LepCand_vse[tau_index]<63 or LepCand_vsmu[tau_index]<1 or LepCand_vsjet[tau_index]<1) continue; 
	//if (LepCand_vse[tau_index]<127 or LepCand_vsmu[tau_index]<1 or LepCand_vsjet[tau_index]<1) continue;//FIXME
	...
	if (sample=="GGTT" or sample=="GGTT_Ctb20"){ // rescaling from mumu region
	   ...
	   if (is_control==0){
	      is_cat0=(mt<75 and ntracks==0 and is_lowA);
              ...
              is_cat3=(mt<75 and (ntracks==0 or ntracks==1) and mvis<100);
              is_cat4=(mt<75 and ntracks<10 and mvis<100 and is_lowA);
              is_cat5=(mt<75 and ntracks<10 and mvis>=100 and is_lowA);
              ...
              is_cat3R=(mt<75 and ntracks<10 and mvis<100 );
              is_cat4R=(mt<75 and ntracks<10 and mvis<100 and is_lowA);
              is_cat5R=(mt<75 and ntracks<10 and mvis>=100 and is_lowA);

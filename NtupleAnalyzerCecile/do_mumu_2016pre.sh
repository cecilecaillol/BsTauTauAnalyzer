...
./FinalSelection_mumu.exe 2016pre /eos/cms/store/group/cmst3/group/taug2/AnalysisCecile/ntuples_mumu_2016pre/GGWW.root output_mumu_2016pre/GGWW.root GGWW GGWW
...
cp datacard_mumu_2016pre.root acocorrected_datacard_mumu_2016pre.root

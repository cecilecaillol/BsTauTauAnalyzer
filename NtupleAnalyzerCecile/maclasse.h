...
// Wed Nov  9 12:30:44 2022 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: /eos/cms/store/user/ccaillol/reNanoAOD/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL18_NanoAODv9/221109_104900/0000/NanoAODv9_85.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nElectron;
   Float_t         Electron_dEscaleDown[4];   //[nElectron]
   Float_t         Electron_dEscaleUp[4];   //[nElectron]
   Float_t         Electron_dEsigmaDown[4];   //[nElectron]
   Float_t         Electron_dEsigmaUp[4];   //[nElectron]
   ...
   UInt_t          nLostTracks;
   Float_t         LostTracks_dxy[109];   //[nLostTracks]
   Float_t         LostTracks_dz[109];   //[nLostTracks]
   Float_t         LostTracks_eta[109];   //[nLostTracks]
   Float_t         LostTracks_mass[109];   //[nLostTracks]
   Float_t         LostTracks_phi[109];   //[nLostTracks]
   Float_t         LostTracks_pt[109];   //[nLostTracks]
   Int_t           LostTracks_charge[109];   //[nLostTracks]
   Int_t           LostTracks_fromPV[109];   //[nLostTracks]
   Int_t           LostTracks_lostInnerHits[109];   //[nLostTracks]
   Int_t           LostTracks_pdgId[109];   //[nLostTracks]
   Bool_t          LostTracks_trackHighPurity[109];   //[nLostTracks]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   UChar_t         Muon_mvaLowPtId[5];   //[nMuon]
   UChar_t         Muon_pfIsoId[5];   //[nMuon]
   UChar_t         Muon_puppiIsoId[5];   //[nMuon]
   ...
   UInt_t          nPhoton;
   Float_t         Photon_dEscaleDown[4];   //[nPhoton]
   Float_t         Photon_dEscaleUp[4];   //[nPhoton]
   Float_t         Photon_dEsigmaDown[4];   //[nPhoton]
   Float_t         Photon_dEsigmaUp[4];   //[nPhoton]
   ...
   Float_t         Photon_mvaID_Fall17V1p1[4];   //[nPhoton]
   ...
   Int_t           Photon_cutBased_Fall17V1Bitmap[4];   //[nPhoton]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/user/ccaillol/reNanoAOD/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL18_NanoAODv9/221109_104900/0000/NanoAODv9_85.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/user/ccaillol/reNanoAOD/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL18_NanoAODv9/221109_104900/0000/NanoAODv9_85.root");
      }

...
using namespace std;
//this code only plot data/MC comparison with cross section reweighting and scale factor in same sign region
...
int main(int argc, char** argv) {
    ...
    TFile *fout = new TFile(Form("~/eos/taug-2/nanoplots/mutau/after_sel/histo/histo_SS%s.root",variable.c_str()),"recreate");
    ...
    */
    ...
    c->SaveAs(Form("Plotsmutau/SSregion/%s_log%d.png",variable.c_str(),log));
    fout->Close();
